...
% called neuralNetworkFunction that can be used to generate outputs for
% the nonusuable data
GenerateNN_Model(Input1, Output1);

%% Step 3: Observe the results from running the generated model on independant labeled data 
[Y2,~,~] = neuralNetworkFunction(Input2');
